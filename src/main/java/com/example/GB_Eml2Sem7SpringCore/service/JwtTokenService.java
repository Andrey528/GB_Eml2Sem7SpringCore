...
@Component
public class JwtTokenService implements Serializable { // Сервис создает токены безопасности
...
//      Any claim can be added if needed
    ...
    public Authentication getAuthentication(String token) { // Проверка того, что пользователь имеет доступ
